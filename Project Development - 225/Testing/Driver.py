        ...
        while traci.simulation.getMinExpectedNumber() > 0:
            ...
            if step % 5 == 0:   
                ...
                for tl in trafficLights:
                    ...
                    print("Time in current phase for", tl.getName(), "is", tl.getTimeInCurrentPhase())  
                    ...
                    print("The traffic light is", tl.getName(), "and does it have an overdue phase?", tl.maxRedPhaseTimeReached())
                    if tl.maxRedPhaseTimeReached() is not False:
                        print("max red phase time reached!")
    ...
    def getState(self, trafficLight):
        ...
        for vehID in traci.vehicle.getIDList(): 
            ...
            if laneID in tlLanes:
                ...
                if traci.vehicle.getSpeed(vehID) == 0 and traci.vehicle.getWaitingTime(vehID) > 0:    
...
if __name__ == "__main__":
    ...
    traci.start([sumoBinary, "-c", "config_file.sumocfg", "--waiting-time-memory", "5", 
                                                            "--time-to-teleport", "-1"])
    run()

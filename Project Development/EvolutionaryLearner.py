...
def createNewGeneration(agentPools, useShoutahead):
    ...
    for ap in agentPools:
        ...
        print("max indivs is " + str(maxIndividuals) + " num of suervivng indivs is " + str(numOfSurvivingIndividuals) + " and num of indivs to mutate is " + str(numOfIndividualsToMutate) + "and the final result is" + str((maxIndividuals-numOfSurvivingIndividuals)-(maxIndividuals*numOfIndividualsToMutate)))
            # Create however many children possible to also leave room for max number of mutations
        for x in range(int((maxIndividuals-numOfSurvivingIndividuals)-(maxIndividuals*numOfIndividualsToMutate))):
...
def crossover(indiv1, indiv2, useShoutahead):
    ...
    for rule in newRS:
        ...
        # Ensure the rule sets are not identical

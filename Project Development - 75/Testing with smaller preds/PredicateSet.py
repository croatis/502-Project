...
def numCarsWaitingToProceedStraight_0_3(carCount):
    if 0 < carCount <= 3:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_3_6(carCount):
    if 3 < carCount <= 6:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_6_9(carCount):
    if 6 < carCount <= 9:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_9_12(carCount):
    if 9 < carCount <= 12:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_12_15(carCount):
    if 12 < carCount <= 15:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_15_20(carCount):
    if 15 < carCount <= 20:
        return True
    else:
        return False

def numCarsWaitingToProceedStraight_20(carCount):
    if carCount > 20:
        return True
    else:
        return False
...
def numCarsWaitingToTurnLeft_0_2(carCount):
    if 0 < carCount <= 2:
        return True
    else:
        return False

def numCarsWaitingToTurnLeft_2_4(carCount):
    if 2 < carCount <= 4:
        return True
    else:
        return False

def numCarsWaitingToTurnLeft_4_6(carCount):
    if 4 < carCount <= 6:
        return True
    else:
        return False

def numCarsWaitingToTurnLeft_6_8(carCount):
    if 6 < carCount <= 8:
        return True
    else:
        return False

def numCarsWaitingToTurnLeft_8_10(carCount):
    if 8 < carCount <= 10:
        return True
    else:
        return False

def numCarsWaitingToTurnLeft_10(carCount):
    if carCount > 10:
        return True
    else:
        return False                                                               
